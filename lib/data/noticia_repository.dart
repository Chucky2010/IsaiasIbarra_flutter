...
class NoticiaRepository {
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutter3/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/cleanarchitecture/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/statemanagement/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/asyncprogramming/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutterweb/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutterdesktop/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/riverpod/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutterfirebase/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/responsivedesign/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/fluttertools/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutter31/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/performance/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutterai/400/200', // URL de la imagen
  //   ),
  //   Noticia(
  ...
  //     imageUrl:
  //         'https://picsum.photos/seed/flutterlibs/400/200', // URL de la imagen
  //   ),
  // ];
  ...
  //     final id = 'noticia_$index';
  //     final titulo = _fuentes[random.nextInt(_fuentes.length)];
  //     final descripcion =
  //         'Descripción de la noticia aleatoria ${random.nextInt(1000)}';
  //     final fuente = _fuentes[random.nextInt(_fuentes.length)];
  //     final publicadaEl = DateTime.now().subtract(
  //       Duration(hours: random.nextInt(48)),
  //     ); // Últimas 48 horas
  //     final imageUrl =
  //         'https://picsum.photos/seed/${titulo.hashCode}/400/200'; // Genera la URL de la imagen
  //     return Noticia(
  //       id: id,
  //       titulo: titulo,
